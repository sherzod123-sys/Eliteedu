          ...
          <div className="md:flex">
            ...
            <div className="md:w-1/3 bg-gradient-to-b from-blue-50 to-purple-50 p-8 flex flex-col items-center justify-center">
              <div className="relative">
                <div className="w-48 h-48 rounded-full bg-gradient-to-br from-blue-500 to-purple-500 flex items-center justify-center text-white text-6xl font-bold mb-4">
